...
app.get('/delete', async (req,res) =>{
  try
  {
    ...
    let discord_response = await discord_api.delete([`/applications/${APPLICATION_ID}/guilds/${GUILD_ID}/commands/1026940698156597259`, `/applications/${APPLICATION_ID}/guilds/${GUILD_ID}/commands/1026940698156597258`])
